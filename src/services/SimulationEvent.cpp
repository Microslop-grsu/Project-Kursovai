...
AnimalArrivedEvent::AnimalArrivedEvent(const ArrivingPetData& petData, const std::string& description)
    : SimulationEvent(EventType::ANIMAL_ARRIVED, -1, description), petData(petData) {}
